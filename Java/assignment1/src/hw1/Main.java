	...
	public static void main(String[] args) {
		...
		case 1:
			if(income <= 16700) {
				...
				tax = 16700* 0.1 + (67900-16700)*0.15 + (137050-67900)*0.25 + 
						(208851-137050)* 0.28 + (income - 208851)* 0.33;
			}
			else {
				tax = tax = 16700* 0.1 + (67900-16700)*0.15 + (137050-67900)*0.25 + 
						(208851-137050)* 0.28 + (income - 208851)* 0.33 + (income - 372950)* 0.35;
		...
		case 2:
			if(income <= 8350) {
				...
				tax = 8350* 0.1 + (33950-8350)*0.15 + (68525-33950)*0.25 + 
						(104425-68525)* 0.28 + (186475 - 104425)* 0.33 + (income - 186475);
